...
Added new folder to the VIews into Areas/Admin and created Index.cshtml and Upsert.cshtml view inside and update the code given..UPDATE README...
...
Now its time for CoverType CRUD operation..
