...
Move Models folder to NidhisBooks.Models project and make neccessary changes into ErrorViewModel.cs file and give reference and change Models folder name to ViewModels..UPDATED README file..